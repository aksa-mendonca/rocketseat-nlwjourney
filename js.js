...
const salvarAtividade = (event) => {
    ...
    if(atividadeExiste) {
        return alert('Dia/Hora não está disponível')
    }
...
const concluirAtividade = (event) => {
    ...
    // Também pode escrever dessa forma (mas o else ñ é necessário, pq se n atender a condicional, ele vai sair da função automaticamente)
    // if(atividade) { -----> (Sem a !, pq ele está querendo mostrar que a atividade existe)
    //     atividade.finalizada = !atividade.finalizada
    // } else {
    //     return
    // }
